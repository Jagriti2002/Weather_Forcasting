...
# Key: 0583da23f75c0f9fccba994e31e2b2a8
...
def get_weather(city):
    weather_key='0583da23f75c0f9fccba994e31e2b2a8'
...
img=Image.open('./BG.png.png')
img=img.resize((600,500),Image.ANTIALIAS)
img_photo=ImageTk.PhotoImage(img)

bg_lbl=tk.Label(win,image=img_photo)
bg_lbl.place(x=0,y=0,width=600,height=500)

heading_title=tk.Label(bg_lbl,text='Earth including over 200,000 cities!',fg='red',bg='Dark Blue',font=('times new roman',18,'bold'))
heading_title.place(x=80,y=18)

frame_one=tk.Frame(bg_lbl,bg="#FF0000",bd=6)
...
frame_two=tk.Frame(bg_lbl,bg="#A52A2A",bd=6)
frame_two.place(x=80,y=130,width=450,height=300)

result=tk.Label(frame_two,font=40,bg='Orange',justify='left',anchor='nw')
